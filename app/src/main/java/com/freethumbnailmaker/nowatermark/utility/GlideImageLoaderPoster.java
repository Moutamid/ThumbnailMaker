...
public class GlideImageLoaderPoster {
    ...
    public void load(final String str, RequestOptions requestOptions) {
        if (str != null && requestOptions != null) {
            ...
            GlideApp.with(this.mImageView.getContext()).load(str).transition((TransitionOptions) DrawableTransitionOptions.withCrossFade()).thumbnail(0.01f).apply(requestOptions.skipMemoryCache(true)).listener((RequestListener) new RequestListener<Drawable>() {
