    ...
    public ArrayList<TextInfo> getTextInfoList(int i) {
        ...
        if (rawQuery == null || rawQuery.getCount() <= 0 || !rawQuery.moveToFirst()) {
            ...
            do {
                ...
                textInfo.setLeftRighShadow(rawQuery.getFloat(26));
                textInfo.setTopBottomShadow(rawQuery.getFloat(27));
                textInfo.setOutLineSize(rawQuery.getInt(28));
                textInfo.setOutLineColor(rawQuery.getInt(29));
